...
_QUERYSUBACCOUNTREQUEST = DESCRIPTOR.message_types_by_name['QuerySubAccountRequest']
_QUERYSUBACCOUNTRESPONSE = DESCRIPTOR.message_types_by_name['QuerySubAccountResponse']
...
QuerySubAccountRequest = _reflection.GeneratedProtocolMessageType('QuerySubAccountRequest', (_message.Message,), {
  'DESCRIPTOR' : _QUERYSUBACCOUNTREQUEST,
  '__module__' : 'counter_pb2'
  # @@protoc_insertion_point(class_scope:counter.QuerySubAccountRequest)
  })
_sym_db.RegisterMessage(QuerySubAccountRequest)

QuerySubAccountResponse = _reflection.GeneratedProtocolMessageType('QuerySubAccountResponse', (_message.Message,), {
  'DESCRIPTOR' : _QUERYSUBACCOUNTRESPONSE,
  '__module__' : 'counter_pb2'
  # @@protoc_insertion_point(class_scope:counter.QuerySubAccountResponse)
  })
_sym_db.RegisterMessage(QuerySubAccountResponse)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _QUERYSUBACCOUNTREQUEST._serialized_start=1520
  _QUERYSUBACCOUNTREQUEST._serialized_end=1575
  _QUERYSUBACCOUNTRESPONSE._serialized_start=1577
  _QUERYSUBACCOUNTRESPONSE._serialized_end=1620
  _COUNTERSERVICE._serialized_start=1623
  _COUNTERSERVICE._serialized_end=2435
